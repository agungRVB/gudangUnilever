    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-lg"><b>GUDANG UNILEVER</b></span>
        </a>
        ...
        <section class="sidebar"><br/>
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <pixels>Hi.. Admin Gudang<?php// echo $nama;?></p>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="?menu=barang"><i class="fa fa-inbox" style="color:orange"></i> <span  style="color:orange">Data Barang</span></a></li>
            <li><a href="?menu=barang-masuk"><i class="fa  fa-truck" style="color:orange"></i> <span style="color:orange">Barang Masuk</span></a></li>
            <li><a href="?menu=barang-keluar"><i class="fa  fa-truck" style="color:orange"></i> <span style="color:orange">Barang Keluar</span></a></li>
            <li><a href="?menu=laporan"><i class="fa fa-folder" style="color:orange"></i> <span style="color:orange">Laporan</span></a></li>
