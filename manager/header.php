        ...
        <section class="sidebar"><br/>
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <pixels>Hi.. Manager Gudang<?php// echo $nama;?></p>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="?menu=laporan-barang"><i class="fa fa-inbox" style="color:orange"></i> <span  style="color:orange">Report Data Barang</span></a></li>
            <li><a href="?menu=laporan-barang-masuk"><i class="fa  fa-truck" style="color:orange"></i> <span style="color:orange">Report Barang Masuk</span></a></li>
            <li><a href="?menu=laporan-barang-keluar"><i class="fa  fa-truck" style="color:orange"></i> <span style="color:orange">Report Barang Keluar</span></a></li>
